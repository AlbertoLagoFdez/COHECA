...
from src.ventana_config import VentanaConfig
...
class App(ctk.CTk):
    ...
    def _build_ui(self):
        self._build_header()
        body, left, right = self._build_body()
        self._build_panel_operacion(left)
        self._build_tabla(left)
        self._build_panel_bus(right)
    ...
    def _build_panel_operacion(self, parent):
        ctrl = ctk.CTkFrame(parent, fg_color=BG_PANEL, corner_radius=12)
    ...
    def _build_tabla(self, parent):
        tabla_outer = ctk.CTkFrame(parent, fg_color=BG_PANEL, corner_radius=12)
    ...
    def _build_panel_bus(self, parent):
        bus_card = ctk.CTkFrame(parent, fg_color=BG_PANEL, corner_radius=12)
    ...
    def _build_historial(self, parent):
        hist_outer = ctk.CTkFrame(parent, fg_color=BG_PANEL, corner_radius=12)
